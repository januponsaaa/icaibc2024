...
if (defined('ELEMENTOR_VERSION')):
    ...
    class EXHIBZ_Shortcode
    {
        ...
        public function __construct()
        {
            ...
            add_action('elementor/controls/register ', array($this, 'exhibz_icon_pack'), 11);
            add_action('elementor/controls/register ', array($this, 'control_image_choose'), 13);
            add_action('elementor/controls/register ', array($this, 'EXHIBZ_ajax_select2'), 13);
            add_action('elementor/widgets/register', array($this, 'EXHIBZ_shortcode_elements'));
        ...
        public function EXHIBZ_shortcode_elements($widgets_manager)
        {
            ...
            $widgets_manager->register(new Elementor\EXHIBZ_Call_To_Action_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/title.php';
            $widgets_manager->register(new Elementor\Exhibz_Title_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/feature.php';
            $widgets_manager->register(new Elementor\Exhibz_Feature_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/speaker.php';
            $widgets_manager->register(new Elementor\Exhibz_Speaker_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/speaker-archive.php';
            $widgets_manager->register(new Elementor\Exhibz_Speaker_Archive_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/schedule.php';
            $widgets_manager->register(new Elementor\Exhibz_Schedule_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/countdown.php';
            $widgets_manager->register(new Elementor\Exhibz_Countdown_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/pricing.php';
            $widgets_manager->register(new Elementor\Exhibz_Pricing_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/latestnew.php';
            $widgets_manager->register(new Elementor\Exhibz_Latestnews_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/mainslider.php';
            $widgets_manager->register(new Elementor\Exhibz_MainSlider_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/date.php';
            $widgets_manager->register(new Elementor\Exhibz_date_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/topics.php';
            $widgets_manager->register(new Elementor\Exhibz_Topics_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/gallery-slider.php';
            $widgets_manager->register(new Elementor\Exhibz_Gallery_Slider_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/video-btn.php';
            $widgets_manager->register(new Elementor\Exhibz_Video_Btn_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/speaker-slider.php';
            $widgets_manager->register(new Elementor\Exhibz_Speaker_Slider_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/meetup.php';
            $widgets_manager->register(new Elementor\Exhibz_Meetup_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/testimonial-slider.php';
            $widgets_manager->register(new Elementor\Exhibz_Testimonial_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-team.php';
            $widgets_manager->register(new Elementor\Exhibz_Team_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/event-category.php';
            $widgets_manager->register(new Elementor\Exhibz_Event_Category_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/multievent-search.php';
            $widgets_manager->register(new Elementor\Multi_Event_Search_Widget());

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/event-category-slider.php';
            $widgets_manager->register(new Elementor\Event_Category_Slider_Widget());

            if (class_exists('Wpeventin')) {
                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-event-tab.php';
                $widgets_manager->register(new Elementor\Exhibz_Events_Tab());

                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/creative-schedule-tab.php';
                $widgets_manager->register(new Elementor\Exhibz_Creative_Schedule_Tab());

                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-event-location.php';
                $widgets_manager->register(new Elementor\Exhibz_Events_Location());

                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-creative-speaker.php';
                $widgets_manager->register(new Elementor\Exhibz_Creative_Speaker_Widget());

                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-event-ticket.php';
                $widgets_manager->register( new Elementor\Exhibz_Event_Ticket_Widget() );
            }

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-button.php';
            $widgets_manager->register(new Elementor\Exhibz_Button_Widget());
