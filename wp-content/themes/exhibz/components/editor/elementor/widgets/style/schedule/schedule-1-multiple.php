      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="tab-content schedule-tabs">
               ...
               ?>
                  <?php if ($j == 1) { ?>
                     <div role="tabpanel" class="test tab-pane active" id="<?php echo esc_attr("date" . $j); ?>" aria-labelledby="<?php echo esc_attr("date" . $j); ?>-tab">
                                       ...
                                       <?php foreach ($multiple_speaker as $key => $value) { ?>
                                          <div class="speaker-content">
                                             <?php if (isset($value['attachment_id'])) : ?>
                                                <?php ++$key;
                                                if ($key == 1) : ?>
                                                   <a rel="noreferrer" href="<?php echo esc_url(get_the_permalink($speaker_id_one)); ?>"> <img class="schedule-slot-speakers <?php echo esc_attr("speaker-img-" . $key); ?>" src="<?php echo wp_get_attachment_url($value["attachment_id"], 'thumbnail'); ?>" title="<?php echo esc_attr($speaker_one); ?>" alt="<?php echo esc_attr("speaker-" . $key); ?>"> </a>
                                                <?php elseif ($key == 2) : ?>
                                                   <a rel="noreferrer" href="<?php echo esc_url(get_the_permalink($speaker_id_two)); ?>"> <img class="schedule-slot-speakers <?php echo esc_attr("speaker-img-" . $key); ?>" src="<?php echo wp_get_attachment_url($value["attachment_id"], 'thumbnail'); ?>" title="<?php echo esc_attr($speaker_two); ?>" alt="<?php echo esc_attr("speaker-" . $key); ?>"> </a>
                                                <?php elseif ($key == 3) : ?>
                                                   <a rel="noreferrer" href="<?php echo esc_url(get_the_permalink($speaker_id_three)); ?>"> <img class="schedule-slot-speakers <?php echo esc_attr("speaker-img-" . $key); ?>" src="<?php echo wp_get_attachment_url($value["attachment_id"], 'thumbnail'); ?>" title="<?php echo esc_attr($speaker_three); ?>" alt="<?php echo esc_attr("speaker-" . $key); ?>"> </a>
                                                <?php endif; ?>
                                             <?php endif; ?>
                  ...
                  <?php } else { //active 
                  ?>
                     <div role="tabpanel" class="tab-pane" id="<?php echo esc_attr("date" . $j); ?>" aria-labelledby="<?php echo esc_attr("date" . $j); ?>-tab">
                        <?php foreach ($schedule_list as $key => $schedule) { ?>
                           <?php
