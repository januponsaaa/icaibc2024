                ...
                <div class="ts-schedule-info mb-70">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        foreach ($posts as $postnav) {
                            ...
                            <?php if ($i == 1) { ?>
                                <li class="nav-item" role="presentation">
                                    <a class="active" title="<?php echo get_the_title($postnav->ID) ?>"
                                       href="<?php echo esc_attr("#date" . $this->get_id() . $i); ?>" role="tab" data-toggle="tab">
                            ...
                            <?php } else { ?>
                                <li class="nav-item" role="presentation">
                                    <a title="<?php echo get_the_title($postnav->ID) ?>" href="<?php echo esc_attr("#date" . $this->get_id() . $i); ?>" role="tab" data-toggle="tab">
                                        <h3><?php echo get_the_title($postnav->ID) ?></h3>
                                            ...
                                            <?php if ($speaker): ?>
                                                <a target="_blank"
                                                   href="<?php echo esc_url(get_the_permalink($speaker_name->ID)); ?>">
                                                    <?php echo wp_get_attachment_image($speaker["attachment_id"], array('80', '80'), "", array( "class" => "schedule-slot-speakers" ) );  ?>
                                                </a>
                                            <?php endif; ?>
                                                ...
                                                <a target="_blank"
                                                   href="<?php echo esc_url(get_the_permalink($speaker_name->ID)); ?>">
                                                    <img class="schedule-slot-speakers"
                                                         src="<?php echo wp_get_attachment_url($speaker  ["attachment_id"], 'thumbnail'); ?>"
