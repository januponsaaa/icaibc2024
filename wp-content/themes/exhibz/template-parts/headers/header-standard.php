...
if (defined('FW')) {
	...
	// if (! $header_btn_show = $button_settings && $header_btn_show !='');
	// if (! $header_btn_url = $button_settings && $header_btn_url != $header_btn_url = $button_settings['header_btn_url']);
	// if (! $header_btn_title = $button_settings && $header_btn_title != $header_btn_title = $button_settings['header_btn_title']);
